...
export default function BadgeScreen() {
  return (
    ...
    >
      <Text className="text-3xl font-semibold text-[var(--learnui-color-foreground)]">Badge</Text>
      <ThemePreviewControl />
      <Text className="text-base text-[var(--learnui-color-foreground)]">
        Status stays meaningful without color. Try maximum text size in each theme.
      </Text>
      {variants.map((variant) => (
        <View key={variant} className="gap-3 rounded-[var(--learnui-radius-surface)] bg-[var(--learnui-color-surface)] p-4">
          <Text className="text-sm font-semibold text-[var(--learnui-color-muted)]">{variant}</Text>
      ...
      <View className="gap-3">
        <Text className="text-sm font-semibold text-[var(--learnui-color-muted)]">Sizes · small and medium</Text>
      ...
      <View className="gap-3">
        <Text className="text-sm font-semibold text-[var(--learnui-color-muted)]">Decorative embedding · owner provides the meaning</Text>
        <Pressable
          accessibilityRole="button"
          accessibilityLabel="Inbox, 3 unread messages"
          className="min-h-11 flex-row flex-wrap items-center gap-3 rounded-[var(--learnui-radius-control)] border border-[var(--learnui-color-border)] p-3"
        >
          <Text className="text-base text-[var(--learnui-color-foreground)]">Inbox</Text>
          <Badge color="accent" isDecorative>3 unread</Badge>
        </Pressable>
      </View>
      <View className="gap-3">
        <Text className="text-sm font-semibold text-[var(--learnui-color-muted)]">Consumer className + style override</Text>
